...
if ($_POST['confirmationCAP'] == "") {
     ...
     )
  {
    ...
    $From = "From: Contact Form <contactform@jriceman.com>\r\n";

    if (!empty($_POST[md5('email' . $_POST['ip'] . $salt . $_POST['timestamp'])])) $From .= "Reply-To: " . $_POST[md5('email' . $_POST['ip'] . $salt . $_POST['timestamp'])] . "\r\n";
